function scr_default_parallax(argument0 = false)
{
    ...
    {
        var _camera = new camera_get_position_struct(view_camera[0]);
        var back_id = layer_background_get_id_fixed(layer_get_id("Backgrounds_sun"));
        var array = -4;
    ...
    {
        var _camera = new camera_get_position_struct(view_camera[0]);
        var back_id = layer_background_get_id_fixed(layer_get_id("Backgrounds_cloudsentry"));
        var array = -4;
        array[0] = _camera.cam_x - clamp(_camera.cam_x * 0.3 * (960 / room_width), 0, sprite_get_width(layer_background_get_sprite(back_id)) - 960);
        array[1] = _camera.cam_y - clamp(_camera.cam_y * 0.6 * (540 / room_height), 0, sprite_get_height(layer_background_get_sprite(back_id)) - 540);
        return array;
    ...
    {
        var _camera = new camera_get_position_struct(view_camera[0]);
        var back_id = layer_background_get_id_fixed(layer_get_id("Backgrounds_scloudsentry"));
        var array = -4;
    ...
    {
        var _camera = new camera_get_position_struct(view_camera[0]);
        var back_id = layer_background_get_id_fixed(layer_get_id("Backgrounds_clock"));
        var array = -4;
        array[0] = _camera.cam_x;
        array[1] = _camera.cam_y - clamp(_camera.cam_y * 0.1 * (540 / room_height), 0, sprite_get_height(layer_background_get_sprite(back_id)) - 540);
        return array;
    };
    
    add_parallax_function("Backgrounds_clock", bg, argument0);
    
    bg = function()
    {
        var _camera = new camera_get_position_struct(view_camera[0]);
        var back_id = layer_background_get_id_fixed(layer_get_id("Backgrounds_clock1"));
        var array = -4;
        array[0] = _camera.cam_x;
        array[1] = _camera.cam_y - clamp(_camera.cam_y * 0.001 * (540 / room_height), 0, sprite_get_height(layer_background_get_sprite(back_id)) - 540);
        return array;
    };
    
    add_parallax_function("Backgrounds_clock1", bg, argument0);
    bg = undefined;
}
